...
public class URLStreamProvider implements StreamProvider {
	...
	public URLStreamProvider(int connectionTimeout, int readTimeout, ComponentSSLConfiguration configuration) {
		this(connectionTimeout, readTimeout, configuration.getTruststorePath(), configuration.getTruststorePassword(),
				configuration.getTruststoreType(), configuration.getKeystorePath(), configuration.getKeystorePassword(),
	...
	public URLStreamProvider(int connectionTimeout, int readTimeout, String path, String password, String type) {
		this(connectionTimeout, readTimeout, path, password, type, null, null, null);
	}
	 ...
	 *            the read timeout in milliseconds
	 */
	public URLStreamProvider(int connectionTimeout, int readTimeout, String trustStorePath, String trustStorePassword,
			String trustStoreType, String keyStorePath, String keyStorePassword, String keyStoreType) {
		this.connTimeout = connectionTimeout;
		this.readTimeout = readTimeout;
		this.path = trustStorePath; // truststroe path
		this.password = trustStorePassword; // truststore password
		this.type = trustStoreType; // truststroe type
	 ...
	 * @param params
	 *            the body of the request; may be null
	 * @param headers
	 *            the headers of the request; may be null
	 *
	 * @return a URL connection
	 *
	 * @throws IOException
	 *             if the URL connection can not be established
	 */
	...
	/**
	 * Utility method to append a new cookie value to an existing list of
	 * cookies.
	 *
	 * @param cookies
	 *            the semicolon separated list of cookie values
	 * @param newCookie
	 *            a new cookie value to be appended.
	 *
	...
	private TrustManager[] getTrustManagers() throws NoSuchAlgorithmException, CertificateException, IOException, 
			KeyStoreException {
